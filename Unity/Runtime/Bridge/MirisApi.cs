...
namespace Miris.Runtime
{
    ...
    public class MirisApi
    {
        ...
        [DllImport(AquaUnityPath)]
        static public extern AquaStatus SetLodRefinementParameters(ClientHandle client, ref LodRefinementParameters refinementParameters);
        ...
        [DllImport(AquaUnityPath)]
        static public extern AquaStatus MarkAttributeArrayAccessed(uint hash0, uint hash1, uint hash2, uint hash3);
