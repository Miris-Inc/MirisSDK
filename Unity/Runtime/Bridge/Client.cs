...
namespace Miris.Runtime
{
    ...
    public class Client : IDisposable
    {
        ...
        public bool SetStreamFetchMode(int streamObjectId, StreamFetchMode mode)
        {
            return MirisBindings.SetStreamFetchMode(m_handle, streamObjectId, mode);
        }

        public StreamFetchMode GetStreamFetchMode(int streamObjectId)
        {
            return MirisBindings.GetStreamFetchMode(m_handle, streamObjectId);
        }
        ...
        public int GetDefaultCameraId(int streamObjectId)
        {
            return MirisBindings.GetDefaultCameraId(m_handle, streamObjectId);
        }

        public int GetViewingVolumeId(int streamObjectId)
        {
            return MirisBindings.GetViewingVolumeId(m_handle, streamObjectId);
        }
        ...
        public void GetBoundingBoxRelativeToAncestor(int sceneObjectId, int ancestorSceneObjectId, float[] boundingBox)
        {
            MirisBindings.GetBoundingBoxRelativeToAncestor(m_handle, sceneObjectId, ancestorSceneObjectId, boundingBox);
        }
