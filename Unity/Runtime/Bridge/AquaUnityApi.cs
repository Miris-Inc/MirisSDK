...
namespace Aqua.Runtime
{
    ...
    public class AquaUnityApi : IDisposable
    {
        ...
        static private void InitializeOnEditorLoad()
        {
        ...
        static private void PlayModeStateChanged(PlayModeStateChange stateChange)
        {
        ...
        public void Dispose()
        {
            ...
            {
                Debug.Log("Destroying AquaClient");
        ...
        [DllImport(AquaUnityPath)]
        static private extern bool IsSceneObjectAncestorOf(AquaClientHandle client, int sceneObjectId, int descendantObjectId);
        ...
        [DllImport(AquaUnityPath)]
        static private extern void GetObjectToWorldTransform(AquaClientHandle client, int sceneObjectId, float[] transformData);
        ...
        {
            Debug.Assert(s_instance != null, "ClearScene: s_instance is null - native client already destroyed!");
            Debug.Assert(s_instance.m_client != IntPtr.Zero, "ClearScene: m_client handle is invalid!");
        ...
        {
            Debug.Assert(s_instance != null, "RemoveStream: s_instance is null - native client already destroyed!");
            Debug.Assert(s_instance.m_client != IntPtr.Zero, "RemoveStream: m_client handle is invalid!");
        ...
        {
            Debug.Assert(s_instance != null, "GetSceneObjectType: s_instance is null - native client already destroyed!");
            Debug.Assert(s_instance.m_client != IntPtr.Zero, "GetSceneObjectType: m_client handle is invalid!");
        ...
        static public bool IsSceneObjectAncestorOf(int sceneObjectId, int descendantObjectId)
        {
            return IsSceneObjectAncestorOf(s_instance.m_client, sceneObjectId, descendantObjectId);
        }
        ...
        static public void GetObjectToWorldTransform(int sceneObjectId, float[] transformData)
        {
            GetObjectToWorldTransform(s_instance.m_client, sceneObjectId, transformData);
        }
    ...
    {
        public AquaSceneObject AddStream(string streamName, string url, bool doNotRefine=false)
        {
...
#endif
            AquaUnityApi.AdvanceTime(deltaTime);
        }
    ...
    public class AquaSceneObject
    {
        ...
        {
            return AquaUnityApi.IsSceneObjectAncestorOf(m_sceneObjectId, sceneObjectId);
        }
        ...
        unsafe public Matrix4x4 GetObjectToWorldTransform()
        {
            float[] matrixData = new float[16];
            AquaUnityApi.GetObjectToWorldTransform(m_sceneObjectId, matrixData);
