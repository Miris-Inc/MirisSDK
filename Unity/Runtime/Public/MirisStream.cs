...
namespace Miris.Runtime
{
    ...
    public class MirisStream : MonoBehaviour
    {
        ...
        /// </summary>
        internal Dictionary<int, GaussianSplatRenderComponent> ModelRoots => m_modelRootObjectIdToRenderComponent;
        ...
        {
            GaussianSplatRenderComponent renderComponent = new(m_renderedExternallyValue);
