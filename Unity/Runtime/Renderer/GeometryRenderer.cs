...
namespace Aqua.Runtime
{
    ...
    public class GeometryRenderer : GaussianSplatRenderer
    {
        ...
        public override void Run(CommandBuffer commandBuffer, Camera camera, AquaTransform transform) {
        ...
        private void SortSplats(CommandBuffer commandBuffer, Camera camera, AquaTransform transform)
        {
            bool doSort = false;
        ...
        private void GPUMapSplats(CommandBuffer commandBuffer, Camera camera, AquaTransform transform, bool shOnly, ComputeBuffer eyeDataBuffer, int firstSplat, int splatsToMapCount, ComputeBuffer gpuSplats) {
            Dispatch3DGSCalculationKernel(commandBuffer, camera, transform, shOnly, eyeDataBuffer, firstSplat, splatsToMapCount, gpuSplats);
        }

        private void DrawSplats(CommandBuffer commandBuffer, AquaTransform transform, int splatsToDrawCount, ComputeBuffer gpuSplatsBuffer, bool isSinglePassXR)
        {
        ...
        private void Draw(CommandBuffer commandBuffer, AquaTransform transform, ShaderPassId shaderPassId, int splatsToDrawCount, ComputeBuffer gpuSplatsBuffer, bool isSinglePassXR)
        {
