...
namespace Miris.Runtime
{
    ...
    public class MosaicTextureToAtlasBufferConverter
    {
        ...
        public void Execute(CommandBuffer commandBuffer)
        {
            ...
            m_DecodeMosaicTextureToAtlasBufferShader.GetKernelThreadGroupSizes( m_DecodeMosaicTextureToAtlasBufferKernel, out uint threadsPerGroupX, out uint threadsPerGroupY, out uint threadsPerGroupZ );
