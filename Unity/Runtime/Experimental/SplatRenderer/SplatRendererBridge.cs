...
namespace Miris.Runtime.Experimental
{
    ...
    public static class SplatRendererBridge
    {
        ...
        // and Shark only renders it. Mutually exclusive with StreamAsset - a context hosts one
        // client. Deferred to the render thread like Create, so 0 means accepted, not adopted.
        [DllImport(MirisApi.AquaUnityPath)]
