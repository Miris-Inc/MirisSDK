...
{
    public class LodCollectionAdapter : BaseObjectAdapter
    {
        public override GameObject Populate(int sceneObjectId, AquaSceneObject sceneObject, MirisStreamController streamController)
        {
            ...
            switch (tileMode)
            {
                case TileCreationMode.OneObjectPerTile:
                    {
                        GaussianSplatRenderComponent rendererComponent = newGameObject.AddComponent(typeof(GaussianSplatRenderComponent)) as GaussianSplatRenderComponent;
                        break;
                    }
            }
        ...
        {
            SceneObjectAdapterRegistry.s_instance.RegisterAdapter(SceneObjectType.LodCollection, () => new LodCollectionAdapter());
        }
    }
}
