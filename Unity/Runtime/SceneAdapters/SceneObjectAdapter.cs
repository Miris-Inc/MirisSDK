...
{
    public class SceneObjectAdapter : BaseObjectAdapter
    {
        ...
        {
            SceneObjectAdapterRegistry.s_instance.RegisterAdapter(SceneObjectType.SceneObject, () => new SceneObjectAdapter());
        }
    }
}
