...
namespace Miris.Tests
{
    public class TestRendererSphericalHarmonics : RendererTestBase
    {
        ...
        static private void SetSHCoeffParameters(MirisAssetRenderComponent splatRenderComponent, int shBand)
        {
        ...
        public IEnumerator TestStreamingHarmonics([ValueSource(nameof(s_SHBand))] int shBand)
        {
            ...
            Assert.IsNotNull(contentPath, "No conditioned content available for spherical harmonics test");
            string contentUrl = MirisTestUtils.BuildDirectContentUrl(contentPath);
            ...
            // Warm up the frames before querying the MirisAssetRenderComponent
            ...
            renderComponent.m_renderPipeline = MirisAssetRenderComponent.Pipeline.Geometry;
