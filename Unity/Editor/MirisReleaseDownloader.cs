...
namespace Aqua.Editor
{
    public class MirisReleaseDownloader : EditorWindow
    {
        ...
        private static string tag = "library@v0.0.7";
        ...
        private void OnGUI()
        {
            ...
            using (new EditorGUILayout.VerticalScope("box"))
            {
                ...
                tag   = EditorGUILayout.TextField(new GUIContent("Tag", "Required. e.g. library@v0.0.7"), tag);

                using (new EditorGUILayout.HorizontalScope())
                {
                    hideToken = EditorGUILayout.ToggleLeft("Hide token", hideToken, GUILayout.Width(90));
                    githubToken = hideToken
                        ? EditorGUILayout.PasswordField(new GUIContent("GitHub Token (optional)"), githubToken)
                        : EditorGUILayout.TextField(new GUIContent("GitHub Token (optional)"), githubToken);
                }
