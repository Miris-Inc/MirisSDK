...
// Must match the variant declared in RenderMirisAssets.hlsl: the keyword is set globally,
...
half4 frag(v2f i) : SV_Target {
    ...
    half4 col = sample_Gaussian(_MirisAssetRT, sampler_MirisAssetRT, i.uv, textureSize);
